	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-bar-chart">&nbsp;</em> 운영결과 결과보고 <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="YearMonthResult.do">
						<span class="fa fa-arrow-right">&nbsp;</span> 연●월 통계
					</a></li>
					<li><a class="" href="">
						<span class="fa fa-arrow-right">&nbsp;</span> 프로그램 운영결과
					</a></li>
					<li><a class="" href="">
						<span class="fa fa-arrow-right">&nbsp;</span> 주제어별 운영결과 검색
					</a></li>
				</ul>
			</li>
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-navicon">&nbsp;</em> 효과 및 만족도 운영결과 <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="#">
