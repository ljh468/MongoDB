...
public class MelonService implements IMelonService {
	...
	public List<MelonDTO> getRank() throws Exception {
		...
		log.info(this.getClass().getName() + ".getRank Stars");
		...
		log.info(this.getClass().getName() + ".GET PANK END");
	...
	public List<MelonSongDTO> getSongForSinger() throws Exception {
		...
		String colNm = "MelonTOP100_20210429";
		String singer = "아이유";
	...
	public List<MelonRankDTO> getCompareRank() throws Exception {
		...
		String curColNm = "MelonTOP100_20210429"; // 현재 랭킹 컬렉션
		String preColNm = "MelonTOP100_20210415"; // 현재 랭킹 컬렉션
